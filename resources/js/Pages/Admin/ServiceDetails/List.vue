            ...
            <div class="lg:max-w-[900px] md:mb-7.5">
                                    <div class="p-7.5 border border-[#dfdfdf] seth ">
                                        <div class="text-right m-2">
                                            <Link :href="route('admin.service_details.create')" class="site-button bg-primary text-white rounded-full h-13.5">Создать</Link>
                                        </div>
                                                    ...
                                                    <td class="border border-gray-400 px-4 py-2">{{ item.description }}</td>
                                                     <td class="border border-gray-400 px-4 py-2 ">
                                                        <div class="flex justify-between items-center space-x-4">
                                                            <Link :href="route('admin.service_details.edit', item.id)">
